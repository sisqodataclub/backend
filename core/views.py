...
def superset_dashboard_data(request):
    ...
    # ---- 4. Umami device metrics (unchanged) ----
    ...
    response = {
        ...
        "superset_charts": superset_charts,   # new field: map chart_id -> data rows
        "superset_errors": errors             # optional: report any chart failures
    }
